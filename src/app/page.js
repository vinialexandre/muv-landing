...
import { Shield, Dumbbell, Target, Trophy } from 'lucide-react';
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
              ...
              >
                <div className="text-center mb-6">
                  <div className="w-20 h-20 rounded-full bg-gradient-to-br from-black to-gray-800 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
                    {(() => { const Icon = modalidade.icon; return <Icon className="w-10 h-10 text-white" />; })()}
                  </div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border-2 border-gray-100">
              <div className="grid md:grid-cols-2 gap-0">
                <div className="bg-gradient-to-br from-black to-gray-900 p-10 text-white">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-300">+55 51 99606-3998</p>
                      </div>
                    </div>
                  ...
                  <div className="mt-10 pt-10 border-t border-white/20">
                    ...
                    <div className="mt-6 text-center">
                      <a
                        href="https://www.muvplataforma.com.br/agenda/HVetxA4Y"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-block bg-[#f6fa36] hover:bg-[#e5e925] text-black px-6 py-2.5 rounded-full font-bold transition-all"
                      >
                        Ver agenda
                      </a>
                    </div>
                ...
                <div className="p-10 flex flex-col justify-center items-center text-center h-full">
                  <h3 className="text-3xl font-bold mb-4">Agende sua Aula</h3>
                  <p className="text-gray-700 text-lg mb-6">Entre em contato para agendar sua aula</p>
                  <div className="flex gap-4">
                    <a href="https://wa.me/5551996063998" target="_blank" rel="noopener noreferrer" className="bg-black hover:bg-gray-800 text-white p-4 rounded-full transition-all">
                    ...
                    <a href="https://www.instagram.com/muv_nh/" target="_blank" rel="noopener noreferrer" className="bg-black hover:bg-gray-800 text-white p-4 rounded-full transition-all">
                      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex-shrink-0 ml-auto text-right">
              ...
              <div className="flex gap-3 justify-end">
                ...
                <a href="https://www.youtube.com/channel/UCPkdwjM7XJYIujBMXPbl-Zg" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 hover:bg-[#f6fa36] rounded-full flex items-center justify-center transition-all hover:scale-110">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      {/* Botão WhatsApp fixo */}
      <a
        href="https://wa.me/5551996063998"
        target="_blank"
        rel="noopener noreferrer"
