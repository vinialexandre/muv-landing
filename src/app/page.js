              ...
              <div className="grid md:grid-cols-2 gap-0">
                ...
                <div className="p-10 flex flex-col justify-center items-center text-center h-full">
                  ...
                  <div className="flex gap-4">
                    <a href="https://wa.me/5551993116869" target="_blank" rel="noopener noreferrer" className="bg-black hover:bg-gray-800 text-white p-4 rounded-full transition-all">
